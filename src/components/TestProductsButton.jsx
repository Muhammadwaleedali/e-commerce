...
const TestProductsButton = () => {
  ...
  const handlePrintProducts = () => {
    console.log("10 Dummy Products:");
    console.log(JSON.stringify(dummyProducts, null, 2));
    message.success("10 dummy products printed to console!");
  };
  ...
  return (
    ...
    >
      Print 10 Dummy Products
    </Button>
  );
};

export default TestProductsButton;